...
For the webpage I have used orange, white, grey and black colors since they provide a good contrast as well as represent the mist common colors found in cats. <br> The following pictures show all individual colors I have used:
- White: <br>
![white](assets/images/White.png) <br>
Created with [Colors](https://coolors.co/gradient-palette/ffffff-f5f5f5?number=2)
- Grey: <br>
![grey0.3](assets/images/lightgrey.PNG)
![grey0.7](assets/images/0.7.PNG)
![grey0.9](assets/images/0.9.PNG)
![grey1](assets/images/1.PNG)
- Orange: <br>
![orange](assets/images/orange.PNG)
- Red and Green for Pros/Cons list: <br>
![red](assets/images/red.PNG)
![green](assets/images/green.PNG) <br>
...
- The homepage "Owning Cats" is giving the user general information about cats, a Pros and Cons list and some general guide if you should own a cat. <br>
...
- The page is responsive and depending on the screen size, it will display between one and four breeds next to each other. <br>
...
- The form is send to the Code Institute dump site. <br>
...
- For small screens, the icons are evenly spaced over the whole footer: <br>
![footer-big](assets/images/footer_wide.PNG)
- For big screens, the icons are more centered in the middle of the footer: <br>
...
- index.html: <br>
![index-validation](assets/images/responsive-index.PNG)
- attributes.html: <br>
![attributes-validation](assets/images/responsive-attributes.PNG)
- survey.html: <br>
![survey-validation](assets/images/responsive-survey.PNG)
### CSS validation via [CSS-validator](https://jigsaw.w3.org/css-validator/validator)
- style.css: <br>
![style-validation](assets/images/responsive-css.PNG)
...
- Mobile: <br>
![mobile-index](assets/images/lighthouse-mobile-index.PNG)
![mobile-attributes](assets/images/lighthouse-mobile-attributes.PNG)
![mobile-survey](assets/images/lighthouse-mobile-survey.PNG)
- Desktop: <br>
![desktop-index](assets/images/lighthouse-desktop-index.PNG)
![desktop-attributes](assets/images/lighthouse-desktop-attributes.PNG)
![desktop-survey](assets/images/lighthouse-desktop-survey.PNG)
